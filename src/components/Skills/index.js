  ...
  return (
    <section className="container-skills" id="skills">
      <div className="description" data-aos="fade-right">
        <h1>Skills to ignite your project.</h1>
      </div>
      ...
      <div className="skills" data-aos="zoom-in">
        ...
        <div className="containerPanelsSkills">
          <div className="buttonsSkills">
            <button
              onClick={() => setTxtButton("frontend")}
              className={`${handleSkillsTab("frontend")}`}
            >
              Front-end
            </button>
            <button
              onClick={() => setTxtButton("backend")}
              className={`${handleSkillsTab("backend")}`}
            >
              Back-end
            </button>
            <button
              onClick={() => setTxtButton("other")}
              className={`${handleSkillsTab("other")}`}
            >
              Others
            </button>
          </div>
